...
<body>
<div id="layout">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-navbar">
        <a class="navbar-brand" href="/bands">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                fill="currentColor" class="bi bi-boombox" viewBox="0 0 16 16">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/bands">Bandas</a>
                </li>
                <li class="nav-item">
        ...
        <div class="div-login-links">
            @auth
                <a class="login-link" href="/dashboard">Dashboard</a>
                <span class="login-link">Olá {{ Auth::user()->name }}</span>
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="login-link logout btn btn-light">Sair</button>
                </form>
            @else
    ...
    <footer class="navbar bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">© Diana Rodrigues</a>
        </div>
    </footer>
</div>
</body>
